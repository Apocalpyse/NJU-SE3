...
public class NotePO {
    ...
    public NotePO(String noteId, String title, String account, String time, NotePool source, String stockCodeOrMethodID, String content , int view, int praise, int criticize, ArrayList<String> comment, ArrayList<String> commentAccount) {
        this.noteId = noteId;
        this.title = title;
