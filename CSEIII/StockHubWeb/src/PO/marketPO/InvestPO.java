...
public class InvestPO {
	...
	public InvestPO(String investID, String title, String time, String author, int view, int praise, int criticize, String content, ArrayList<String> comment, ArrayList<String> commentAccount) {
