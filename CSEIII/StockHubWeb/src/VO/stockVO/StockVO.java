...
public class StockVO {
    ...
    private String industry;//股票所属行业

    public StockVO() {
    }

    public StockVO(String date, String open, String high, String low, String close, String volume, String adjClose, String code, String name, String market, String increaseOrDecrease, String preAdjClose, String plate,String industry) {
        this.date = date;
        this.open = open;
        this.high = high;
        this.low = low;
