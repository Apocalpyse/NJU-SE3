 ...
 */
public class findIndustryMaxInVolume extends HttpServlet{
	private static final long serialVersionUID = 1L;
	private Industry industry;
	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public findIndustryMaxInVolume(){
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String industryName= URLDecoder.decode(request.getParameter("industryName"),"UTF-8");

		ArrayList<StockVO> arrayList = null;
		try {
			arrayList=industry.findIndustryMaxInVolume(date,industryName);
		} catch (Exception e) {
			e.printStackTrace();
		}
		synchronized(this){
