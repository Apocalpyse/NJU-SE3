 ...
 */
public class addSelfSelectStock extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private User user;
	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public addSelfSelectStock(){
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String string= null;
		try {
			string = user.addSelfSelectStock(new SelfSelectStockVO(account,one,two,three))+"";
		} catch (Exception e) {
			e.printStackTrace();
		}
