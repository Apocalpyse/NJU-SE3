 ...
 */
public class getDecreaseList extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private MarketSituation marketSituation;
	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public getDecreaseList(){
		super();
	...
	public static void main(String[] args){
		...
		try {
			arrayList=marketSituation.getDecreaseList("4/1/16");
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<StockVO> arrayList = null;
		try {
			arrayList=marketSituation.getDecreaseList(date);
		} catch (Exception e) {
			e.printStackTrace();
		}
		synchronized(this){
