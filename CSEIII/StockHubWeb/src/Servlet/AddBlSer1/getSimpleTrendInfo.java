...
import VO.stockVO.SimpleTrendVO;
 ...
 */
public class getSimpleTrendInfo extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<SimpleTrendVO> arrayList = null;
		try {
			arrayList=addOne.getSimpleTrendInfo(industryName,date);
		} catch (Exception e) {
			e.printStackTrace();
		}
		synchronized(this){
