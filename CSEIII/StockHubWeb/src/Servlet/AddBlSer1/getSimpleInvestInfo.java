 ...
 */
public class getSimpleInvestInfo extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<SimpleInvestNewsVO> arrayList = null;
		try {
			arrayList=addOne.getSimpleInvestInfo(industryName,date);
		} catch (Exception e) {
			e.printStackTrace();
		}
		synchronized(this){
