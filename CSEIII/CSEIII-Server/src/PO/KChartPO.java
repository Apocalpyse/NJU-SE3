...
public class KChartPO {
    ...
    public KChartPO(String stockCode, String stockName, String lastDatePrice,
                    String lastDateIncOrDecRate, ArrayList<String> date, ArrayList<Double> adjClose) {
