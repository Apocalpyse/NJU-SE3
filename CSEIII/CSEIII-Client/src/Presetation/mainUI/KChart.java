...
/**
 * Created by 常德隆 on 2017/3/15.
 */
public class KChart<X,Y> extends XYChart<X,Y> {
    ...
    public KChart(Axis<X> xAxis, Axis<Y> yAxis) {
        super(xAxis, yAxis);
        getStylesheets().add(getClass().getResource("KChartStyles.css").toExternalForm());
    ...
    protected void layoutPlotChildren() {
        ...
        for (int seriesIndex = 0; seriesIndex < getData().size(); seriesIndex++) {
            ...
            while (iterator.hasNext()) {//TODO Add bars limit
                ...
                KChart.CandleStickExtraValues<Y> extra = (KChart.CandleStickExtraValues<Y>) item.getExtraValue();
        ...
        if (xData != null || yData != null) {
            for (Series<X, Y> series : getData()) {
                for (Data<X, Y> data : series.getData()) {
                    ...
                    if (yData != null) {
                        KChart.CandleStickExtraValues<Y> extras = (KChart.CandleStickExtraValues<Y>) data.getExtraValue();
                        if (extras != null) {
