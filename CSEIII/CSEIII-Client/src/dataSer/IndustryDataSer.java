...
public interface IndustryDataSer extends Remote{
	 ...
	 * @throws Exception
	 */
	public ArrStockPO getPoolInfo(String start, String end,StockPool stockPool) throws RemoteException;
	/**
	 ...
	 * @throws Exception
	 */
	public ArrStockPO getIndustryInfo(String start, String end, String industry) throws RemoteException;
	/**
	 * * 用户输入输入股票代码，返回名字
	 * @param code
	 * @return
	 * @throws Exception
	 */
	public String getName(String code) throws RemoteException;
	/**
	 * * 用户输入输入股票名字，返回代码
	 * @param name
	 * @return
	 * @throws Exception
	 */
	public String getCode(String name) throws RemoteException;
