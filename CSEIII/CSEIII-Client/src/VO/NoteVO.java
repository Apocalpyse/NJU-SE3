...
public class NoteVO {
	...
	public NoteVO(String noteId, String title, String account, String time, NotePool source, String stockCodeOrMethodID, int view, int praise, int criticize, ArrayList<String> comment, ArrayList<String> commentAccount) {
		this.noteId = noteId;
		this.title = title;
