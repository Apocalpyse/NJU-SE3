...
public class NewsVO {
	...
	public NewsVO(String newsID, String title, String author, String time, String source, int view, int praise, int criticize, String content, ArrayList<String> comment, ArrayList<String> commentAccount) {
		this.newsID = newsID;
		this.title = title;
		this.author = author;
		this.time = time;
