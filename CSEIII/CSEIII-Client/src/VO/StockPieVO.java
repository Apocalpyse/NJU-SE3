...
public class StockPieVO {
    ...
    private double decStop;//跌停的股票占比
    private double rateLessNeg5;//跌幅大于5%的股票占比，如占比16.8%时，rateLessNeg5=16.8
    private double rateFromNeg5ToZero;//跌幅在-5%到0之间的股票占比
    private double rateFromZeroTo5;//涨幅在0%到5%之间的股票占比
    private double rateMore5;//涨幅大于5%的股票占比
    private double incStop;//涨停的股票占比
