...
public class BuyVO {
    ...
    public BuyVO(String account, String date, ArrayList<String> buyCode, ArrayList<String> buyMoney, ArrayList<String> buyCopies, ArrayList<String> sellCode, ArrayList<String> sellMoney, ArrayList<String> sellCodpies) {
